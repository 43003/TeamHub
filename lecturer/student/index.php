                ...
                <ul class="list-group">
                  ...
                  <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                    ...
                    <div class="ms-auto text-end">
                      <div class="row">
                        <a class="btn btn-link text-info px-3 mb-0" href="index.php?data=<?php print base64_encode($dir.'/student/table.php;Student;Student List;;;;'); ?>&cid=<?=$rs->fields['course_ID']?>">
                          <i class="material-icons text-sm me-2">visibility</i>View Student
                        </a>
                      </div>
                    </div>
                  </li>
