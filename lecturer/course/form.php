        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="input-group input-group-outline my-3">
              <input id="course_code" name="course_code" type="text" class="form-control" value="" onkeyup="upperCase(this)">
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-10">
            <div class="input-group input-group-outline my-3">
              <input id="course_name" name="course_name" type="text" class="form-control" value="" onkeyup="upperCase(this)">
            </div>
          </div>
        </div>
        <div class="row">
